...
const ProjectCard = ({project}: {project: Project}) => {
    ...
    return (
        <div className="flex flex-col md:flex-row group border border-gray-200 bg-gray-50 rounded-xl overflow-hidden cursor-pointer hover:shadow-md hover:scale-101 transition-all duration-300 md:h-64">
            ...
            <div className="flex flex-1 flex-col justify-between p-5 min-w-0">
                <div className="flex flex-col gap-2">
                    <div className="flex flex-row justify-between items-start">
                        ...
                        <ArrowUpRight className="shrink-0 transition-transform duration-300 ease-in-out transform translate-y-0 group-hover:-translate-y-2"/>
                    </div>
